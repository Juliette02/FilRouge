...
$produits = array(
	array(
		...
		"rubrique_id" => 22,
		"fournisseur_id" => 3,
		"libelle_court" => "The box pro Achat 104",
		"libelle_long" => "
		Enceinte large bande passive 4\" + 1\"
		
			Puissance: 40 Watt / 8 Ohm (RMS) - 160 Watt / 8 Ohm (crête)
			Réponse en fréquence: 100 Hz - 20 kHz
			SPL max: 109 dB
			Dispersion: 90° x 90°
			2x connecteurs Speaker Twist NL4 et borniers
			Montage aérien pas de vis M6
			Dimensions: 144 x 146 x 214 mm
			Poids: 2,5 kg
			Couleur: noire
			Support de montage mural disponible en option, article n°: 251424
			Conçue en Allemagne
	...
	array(
		...
		"rubrique_id" => 22,
		"fournisseur_id" => 4,
		"libelle_court" => "HK Audio Premium PR:O 15",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 23,
		"fournisseur_id" => 5,
		"libelle_court" => "the t.bone MB 88U Dual",
		"libelle_long" => "
		Microphone de chant dynamique
	...
	array(
		...
		"rubrique_id" => 23,
		"fournisseur_id" => 3,
		"libelle_court" => "Sennheiser E835 S",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 24,
		"fournisseur_id" => 2,
		"libelle_court" => "Behringer Xenyx X2222USB",
		"libelle_long" => "
		Table de mixage
	...
	array(
		...
		"rubrique_id" => 24,
		"fournisseur_id" => 4,
		"libelle_court" => "the t.mix xmix 1002 FX USB",
		"libelle_long" => "
		Mélangeur 10 canaux
	...
	array(
		...
		"rubrique_id" => 24,
		"fournisseur_id" => 1,
		"libelle_court" => "Soundcraft Signature 12MTK",
		"libelle_long" => "
		Console de mixage 12 canaux
	...
	array(
		...
		"rubrique_id" => 18,
		"fournisseur_id" => 4,
		"libelle_court" => "Roland FR-4 X BK",
		"libelle_long" => "
		Accordéon numérique
	...
	array(
		...
		"rubrique_id" => 18,
		"fournisseur_id" => 1,
		"libelle_court" => "Startone Piano Accordion 72 Blue MKII",
		"libelle_long" => "
		Accordéon piano
	...
	array(
		...
		"rubrique_id" => 18,
		"fournisseur_id" => 3,
		"libelle_court" => "Weltmeister Saphir 41/120/IV115",
		"libelle_long" => "
		Accordéon piano
	...
	array(
		...
		"rubrique_id" => 19,
		"fournisseur_id" => 2,
		"libelle_court" => "Salvi SALDEL-ESS Delta Ebony",
		"libelle_long" => "
		Harpe électrique
	...
	array(
		...
		"rubrique_id" => 19,
		"fournisseur_id" => 5,
		"libelle_court" => "Thomann SQB Celtic Harp Beech 29 Str",
		"libelle_long" => "
		Harpe celtique
	...
	array(
		...
		"rubrique_id" => 19,
		"fournisseur_id" => 1,
		"libelle_court" => "Auris My Little Lyre",
		"libelle_long" => "
		Lyre
	...
	array(
		...
		"rubrique_id" => 20,
		"fournisseur_id" => 4,
		"libelle_court" => "Thomann 111VN 3/4 Double Bass",
		"libelle_long" => "
		Contrebasse 3/4
	...
	array(
		...
		"rubrique_id" => 20,
		"fournisseur_id" => 3,
		"libelle_court" => "Duke Two Tone BRG Double Bass 3/4",
		"libelle_long" => "
		Contrebasse 3/4
	...
	array(
		...
		"rubrique_id" => 20,
		"fournisseur_id" => 2,
		"libelle_court" => "Thomann Rockabilly Psycho Slap BK/RD",
		"libelle_long" => "
		Contrebasse 3/4
	...
	array(
		...
		"rubrique_id" => 2,
		"fournisseur_id" => 4,
		"libelle_court" => "Fender Jim Root Stratocaster EB BK",
		"libelle_long" => "
		Guitare électrique
	...
	array(
		...
		"rubrique_id" => 2,
		"fournisseur_id" => 2,
		"libelle_court" => "ESP LTD MH-10 Black",
		"libelle_long" => "
		Guitare électrique
	...
	array(
		...
		"rubrique_id" => 3,
		"fournisseur_id" => 5,
		"libelle_court" => "Harley Benton GL-2NT Guitarlele",
		"libelle_long" => "
		Guitalélé
	...
	array(
		...
		"rubrique_id" => 3,
		"fournisseur_id" => 2,
		"libelle_court" => "Startone CG-851 1/8 Pink",
		"libelle_long" => "
		Guitare classique
	...
	array(
		...
		"rubrique_id" => 4,
		"fournisseur_id" => 3,
		"libelle_court" => "Taylor Baby Mahogany-e BT2e",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 4,
		"fournisseur_id" => 1,
		"libelle_court" => "Furch LJ-10",
		"libelle_long" => "
		Guitare acoustique de voyage pliable
	...
	array(
		...
		"rubrique_id" => 4,
		"fournisseur_id" => 2,
		"libelle_court" => "LAVA MUSIC ME 2 BK",
		"libelle_long" => "
		Guitare acoustique compacte
	...
	array(
		...
		"rubrique_id" => 9,
		"fournisseur_id" => 1,
		"libelle_court" => "Kawai K 15 E E/P Piano",
		"libelle_long" => "
		Piano droit
	...
	array(
		...
		"rubrique_id" => 10,
		"fournisseur_id" => 2,
		"libelle_court" => "Kawai GL 10 E/P Grand Piano",
		"libelle_long" => "
		Piano à queue
	...
	array(
		...
		"rubrique_id" => 10,
		"fournisseur_id" => 2,
		"libelle_court" => "Yamaha C 3 X PE Grand Piano",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 10,
		"fournisseur_id" => 2,
		"libelle_court" => "Steinway & Sons B-211",
		"libelle_long" => "
		Piano à queue
	...
	array(
		...
		"rubrique_id" => 11,
		"fournisseur_id" => 3,
		"libelle_court" => "Thomann DP-95 WH",
		"libelle_long" => "
		Piano numérique
	...
	array(
		...
		"rubrique_id" => 11,
		"fournisseur_id" => 3,
		"libelle_court" => "Hemingway DP-501 MKII AT",
		"libelle_long" => "
		Piano numérique
	...
	array(
		...
		"rubrique_id" => 11,
		"fournisseur_id" => 3,
		"libelle_court" => "Kawai CN-29 B Set",
		"libelle_long" => "
		Kawai CN-29 B
	...
	array(
		...
		"rubrique_id" => 13,
		"fournisseur_id" => 4,
		"libelle_court" => "Yamaha YAS-280 Alto Sax",
		"libelle_long" => "
		Saxophone alto
	...
	array(
		...
		"rubrique_id" => 13,
		"fournisseur_id" => 4,
		"libelle_court" => "Thomann TAS-180 Alto Sax",
		"libelle_long" => "
		Saxophone alto
	...
	array(
		...
		"rubrique_id" => 13,
		"fournisseur_id" => 4,
		"libelle_court" => "Startone SAS-75 Alto Sax",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 14,
		"fournisseur_id" => 5,
		"libelle_court" => "Thomann TR 5 Bb-Pocket Trumpet",
		"libelle_long" => "
		Trompette de poche en Sib
	...
	array(
		...
		"rubrique_id" => 14,
		"fournisseur_id" => 5,
		"libelle_court" => "Thomann TR 200 Bb-Trumpet",
		"libelle_long" => "
		Trompette en Sib
	...
	array(
		...
		"rubrique_id" => 14,
		"fournisseur_id" => 5,
		"libelle_court" => "Bach TR-450S Bb- Trumpet",
		"libelle_long" => "
		Trompette en Sib
	...
	array(
		...
		"rubrique_id" => 15,
		"fournisseur_id" => 1,
		"libelle_court" => "Thomann 12H Ocarina C3 dark blue",
		"libelle_long" => "
		Ocarina 12 trous
	...
	array(
		...
		"rubrique_id" => 15,
		"fournisseur_id" => 1,
		"libelle_court" => "Thomann AC Stein Double Ocarina reg.",
		"libelle_long" => "
		Double ocarina en pierre
	...
	array(
		...
		"rubrique_id" => 15,
		"fournisseur_id" => 1,
		"libelle_court" => "Thomann Zfan Fairy Ocarina AC 12-H C3",
		"libelle_long" => "
		Ocarina alto 12 trous
	...
	array(
		...
		"rubrique_id" => 16,
		"fournisseur_id" => 1,
		"libelle_court" => "Thomann FL-200R Flute Open Holes",
		"libelle_long" => "
		Flûte traversière
	...
	array(
		...
		"rubrique_id" => 16,
		"fournisseur_id" => 1,
		"libelle_court" => "Muramatsu EX-III-RBE Flute",
		"libelle_long" => "
		Flûte traversière
	...
	array(
		...
		"rubrique_id" => 16,
		"fournisseur_id" => 1,
		"libelle_court" => "Pearl Flutes PF-505 RE Quantz Flute",
		"libelle_long" => "
		Flûte traversière
	...
	array(
		...
		"rubrique_id" => 26,
		"fournisseur_id" => 1,
		"libelle_court" => "Eurolite LED SL-400 DMX Search Light",
		"libelle_long" => "
		Poursuite avec LED blanc chaud de 300 Watt
	...
	array(
		...
		"rubrique_id" => 26,
		"fournisseur_id" => 1,
		"libelle_court" => "Cameo Matrix Panel 10 W RGB",
		"libelle_long" => "
		Panneau matriciel RVB
	...
	array(
		...
		"rubrique_id" => 27,
		"fournisseur_id" => 1,
		"libelle_court" => "Stairville Wild Wash 132 LED RGB",
		"libelle_long" => "
		Projecteur multifonctionnel SMD LED
	...
	array(
		...
		"rubrique_id" => 27,
		"fournisseur_id" => 1,
		"libelle_court" => "Martin by Harman Atomic 3000 LED",
		"libelle_long" => "
		Stroboscope à LEDs
	...
	array(
		...
		"rubrique_id" => 27,
		"fournisseur_id" => 1,
		"libelle_court" => "Varytec Colors SonicStrobe",
		"libelle_long" => "
		Stroboscope LED avec effet d'ambiance
	...
	array(
		...
		"rubrique_id" => 28,
		"fournisseur_id" => 1,
		"libelle_court" => "Laserworld DS-1000RGB MK3",
		"libelle_long" => "
		Système laser \"Pure Diode\" RVB
	...
	array(
		...
		"rubrique_id" => 28,
		"fournisseur_id" => 1,
		"libelle_court" => "ADJ Stinger II",
		"libelle_long" => "
		Effets Moonflower/stroboscope/laser
	...
	array(
		...
		"rubrique_id" => 28,
		"fournisseur_id" => 4,
		"libelle_court" => "Laserworld PL-5000RGB MK2",
		"libelle_long" => "
		Laser couleur à diode haute puissance Purelight
	...
	array(
		...
		"rubrique_id" => 30,
		"fournisseur_id" => 4,
		"libelle_court" => "Gravity LTS 01 B Set",
		"libelle_long" => "
		Gravity LTS 01 B
	...
	array(
		...
		"rubrique_id" => 30,
		"fournisseur_id" => 4,
		"libelle_court" => "Roadworx Multi Electric Stand",
		"libelle_long" => "
		Support à hauteur réglable électrique
	...
	array(
		...
		"rubrique_id" => 30,
		"fournisseur_id" => 1,
		"libelle_court" => "Standback Ampstand",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 31,
		"fournisseur_id" => 3,
		"libelle_court" => "Millenium MDT5S-Pro Drum Throne Saddle",
		"libelle_long" => "
		Siège pour batteur
	...
	array(
		...
		"rubrique_id" => 31,
		"fournisseur_id" => 3,
		"libelle_court" => "Mapex MXT765ASER Drum Stool",
		"libelle_long" => "
		Siège pour batteur
	...
	array(
		...
		"rubrique_id" => 31,
		"fournisseur_id" => 3,
		"libelle_court" => "DW 9120AL Drum Stool",
		"libelle_long" => "
		Siège pour batteur
	...
	array(
		...
		"rubrique_id" => 32,
		"fournisseur_id" => 3,
		"libelle_court" => "Boss Waza Air Guitar Headphones",
		"libelle_long" => "
		Système audio pour guitare avec casque sans fil
	...
	array(
		...
		"rubrique_id" => 32,
		"fournisseur_id" => 3,
		"libelle_court" => "Metrophones MPD-G Headphones LCD Metronom",
		"libelle_long" => "
		Casque pour batteur
	...
	array(
		...
		"rubrique_id" => 6,
		"fournisseur_id" => 3,
		"libelle_court" => "Pearl EXX725SBR/C Export Aztec Gold",
		"libelle_long" => "
		Batterie complète - Version Fusion 2
	...
	array(
		...
		"rubrique_id" => 6,
		"fournisseur_id" => 3,
		"libelle_court" => "Tama STAR Drum Bubinga White Ebony",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 6,
		"fournisseur_id" => 5,
		"libelle_court" => "Sonor AQX Jungle Set BOS",
		"libelle_long" => "
		Set de fûts - Shell Set
	...
	array(
		...
		"rubrique_id" => 7,
		"fournisseur_id" => 2,
		"libelle_court" => "Roland VAD706-GC E-Drum Set Bundle",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 7,
		"fournisseur_id" => 3,
		"libelle_court" => "Alesis Strike Pro Special Edition",
		"libelle_long" => "
	...
	array(
		...
		"rubrique_id" => 7,
		"fournisseur_id" => 3,
		"libelle_court" => "Millenium HD-120 E-Drum Set",
		"libelle_long" => "
		Batterie électronique complète
